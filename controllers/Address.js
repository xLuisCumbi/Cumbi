...
/**
 * Generates and returns a deposit address for a specific network and
 * coin using a mnemonic phrase and an address index.
 ...
 */
module.exports = getDepositAddress = (network, coin, index) => new Promise(
 ...
 */
const getErc20Address = (privateKey) => new Promise(async (resolve, reject) => {
  try {
 ...
 * @return {Promise<string>} - The generated address.
 */
const getTrc20Address = (privateKey) => new Promise((resolve, reject) => {
  try {
 ...
 */
const getAddressIndex = (network, coin) => new Promise((resolve, reject) => {
