 ...
 */
const activateEthAddress = (mainAddrObj, address) => new Promise(async (resolve) => {
 ...
 */
const activateTronAddress = (mainAddrObj, address) => new Promise(async (resolve) => {
  ...
  const balance = await tronWeb.trx.getBalance(mainAddrObj.address);
 ...
 */
const confirmTronTransaction = (transferTransactionId, tronWeb) => new Promise(async (resolve) => {
